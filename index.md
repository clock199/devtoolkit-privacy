...
- The content you process using any of the tools

## How the App Works

All text processing — including Base64 encoding, SHA256 hashing, URL encoding, UUID generation, case conversion, timestamp conversion, JWT decoding, regex testing, and JSON formatting — is performed entirely on your device. No data is sent to any server.
